...
import (
	...
	"github.com/nikhileshsirohi/Restaurant-Management/pkg/models"
...
func GetMenus() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occuring while listing the menu items"})
		}
		var allMenus []bson.M
